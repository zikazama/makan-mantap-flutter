...
class NotificationHelper {
  ...
  Future<void> showNotification(
      ...
      RestaurantsResult listResto) async {
    var _channelId = "1";
    var _channelName = "channel_01";
    var _channelDescription = "daily restaurant chanel";
    ...
    var titleNotification = "<b>Ayo cari makanan dengan harga murah</b>";
    var titleNews = listResto.restaurants[0].name;

    await flutterLocalNotificationsPlugin.show(
        0, titleNotification, titleNews, platformChannelSpecifics,
        payload: json.encode(listResto.toJson()));
  }
